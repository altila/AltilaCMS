...
class SitePlateContentAction extends ABaseAction {
	...
	*/
	public function _before_insert() {
		...
		else if( $_REQUEST['model'] == 3 && in_array($_REQUEST['type'],array(1,2)) ) $_POST['model_value'] = $_REQUEST['model3'];
		else if( $_REQUEST['model'] == 3 && in_array($_REQUEST['type'],array(7)) ) $_POST['model_value'] = $_REQUEST['model3_7'];
		else if( $_REQUEST['model'] == 4 && in_array($_REQUEST['type'],array(1,2)) ) $_POST['model_value'] = $_REQUEST['model4'];
		else if( $_REQUEST['type'] == 5 ) $_POST['model_value'] = $_REQUEST['model5'];
