...
(function () {
     ...
     */
    URL = window.UEDITOR_HOME_URL||"/Public/ueditor/js/";//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/AdminBase/ArticleAlbumPhoto/imgUplode"                  //图片上传提交地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:"/AdminBase/ArticleAlbumPhoto/imgManagerIndex"  //图片在线管理的处理地址
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'emotion', 'insertvideo','music', 'map', 'gmap', 'insertframe','highlightcode','pagebreak', '|',
