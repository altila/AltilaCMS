...
return  array(
    ...
    'APP_SUB_DIR_DENY_LIST' => '',      // 项目子目录禁止访问列表
    'APP_SUB_DOMAIN_DEPLOY' => false,   // 开启项目子域名部署
    'APP_SUB_DOMAIN_RULES'  => array(), // 子域名部署规则 '子域名'=>array('项目名/[分组名]','var1=a&var2=b');
    ...
    'DEFAULT_LAYOUT'        => '_layout.html', //  默认布局模板 相对于TEMPLATE_PATH路径

    /* 数据库设置 */
    'DB_TYPE'               => 'mysql',     // 数据库类型
    'DB_HOST'               => 'localhost', // 服务器地址
    'DB_NAME'               => '',          // 数据库名
    'DB_USER'               => 'openmall',  // 用户名
    'DB_PWD'                => '',          // 密码
    'DB_PORT'               => 3306,        // 端口
    ...
    'URL_HTML_SUFFIX'       => '',      // URL伪静态后缀设置 shtml html

    /* 系统变量名称设置 */
    'VAR_APP'               => 'app',   // 默认项目获取变量
    ...
    'VAR_PATHINFO'          => 's',     // PATHINFO 兼容模式获取变量例如 ?s=/module/action/id/1 后面的参数取决于 URL_PATHINFO_DEPR
